---
layout: mypost
title: "Simplify Path - Short stack solution"
tags: ["String", "Stack", "Python3", "Medium"]
---
# Problem Statement:
...
There is a bug in the question though IMO. For the case of `"/../a"` it should be expecting some generic answer like `"Invalid path"` because you cannot go above root. Instead, we need to return `"/a"`. This is why I had to to put `if res: res.pop()`. Instead the correct question would require something like `if not res return "Invalid Path" else res.pop()`